...
export default function GlyphComponent() {
  ...
  const [editingMode, setEditingMode] = useState<'full' | 'half' | 'first' | 'middle' | 'last'>('full');
  ...
  const customStyles = {
    control: (base: any, state: any) => ({
      ...
      border: state.isFocused ? '1px solid #8b1e3f' : '1px solid rgba(139, 30, 63, 0.15)',
      borderRadius: '12px',
      padding: '2px 8px',
      boxShadow: 'none',
      cursor: 'pointer',
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
            {[
              ...
              { label: 'X-Offset', key: 'x_offset' as const, min: -100, max: 100, step: 1, unit: 'px' },
              { label: 'Y-Offset', key: 'y_offset' as const, min: -100, max: 100, step: 1, unit: 'px' },
              ...
              { label: 'Crop Top', key: 'crop_top' as const, min: 0, max: 200, step: 1, unit: 'px' },
              { label: 'Crop Bottom', key: 'crop_bottom' as const, min: 0, max: 200, step: 1, unit: 'px' },
              { label: 'Crop Left', key: 'crop_left' as const, min: 0, max: 200, step: 1, unit: 'px' },
